...
export default function LoginModal({ isOpen, onClose, onSwitchToRegister }) {
    ...
    return (
        <div className="modal-overlay" onClick={onClose}>
            <div className="modal-content rounded-[20px] w-[550px] h-[700px] relative flex flex-col items-center justify-center" onClick={(e) => e.stopPropagation()}>
                {/* Logo */}
                <div className="mb-12">
                    <img 
                ...
                <form onSubmit={handleSubmit} className="w-[303px]">
                    ...
                    <button 
                        type="submit"
                        className="w-full h-[50px] btn-primary text-xl mb-6"
                    >
                        เข้าสู่ระบบ
                    </button>
                    ...
                    <div className="flex gap-4 mb-8">
                        ...
                        <button 
                            ...
                            className="flex-1 h-[38px] btn-outline-primary text-lg"
                        >
                            สมัครสมาชิก
                        </button>
                    </div>
