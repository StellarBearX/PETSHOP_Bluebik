  ...
  return (
    <main className="min-h-screen bg-[#F7F7F7]">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        {/* Breadcrumb */}
        <div className="flex items-center gap-2 py-4 sm:py-6 text-sm sm:text-base lg:text-[20px] font-['Inter']">
        ...
        <div className="mb-8 sm:mb-12">
          <div className="bg-gradient-to-r from-[#FF4D00] to-[#F99D20] rounded-xl h-[120px] sm:h-[140px] lg:h-[163px] flex flex-col items-center justify-center shadow-lg">
            <div className="flex items-center gap-2 sm:gap-4 mb-2 sm:mb-4">
              ...
              />
              <h1 className="text-white text-xl sm:text-2xl lg:text-[32px] font-bold font-['Inter'] leading-normal -tracking-[0.333px]">
                Flash Deal
              </h1>
            </div>
            <p className="text-white text-sm sm:text-base lg:text-[20px] font-['Inter'] leading-normal -tracking-[0.333px]">
        ...
        <div className="mb-8">
          ...
          <div className="bg-white h-[40px] sm:h-[45px] flex items-center justify-between px-4 rounded-t mb-0 shadow-[0_1px_4px_0_rgba(0,0,0,0.25)]">
            <h2 className="text-[#FF4D00] text-base sm:text-lg lg:text-[20px] font-bold font-['Inter'] leading-normal -tracking-[0.333px]">
